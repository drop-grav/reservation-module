...
COPY reserveddates(startDate, endDate, numGuests, numInfants, listingID) FROM '/home/jared/hackreactor/sdc/reservation-module/database/reservations.csv' DELIMITER ',' CSV HEADER;
